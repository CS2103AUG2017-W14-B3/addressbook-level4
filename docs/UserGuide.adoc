...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01, b/19/09/1999`
...
* `list` +
`email 2 3` +
Send an email to the 2nd person and 3rd person in the address book.
* `find Betsy` +
`email 1` +
...
Allows you to import contacts from either Google Contacts or Apple iCloud.

Format: `import SERVICE_NAME`

****
* The service name can only be "Google" or "Apple"
...
2. Once access has been granted, a progress window will pop up indicating the progress of import.
